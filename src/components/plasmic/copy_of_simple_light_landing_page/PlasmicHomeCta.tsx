...
import * as sty from "./PlasmicHomeCta.module.css"; // plasmic-import: mTkzTm28FjqyB/css

import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: zxjh0ajYVhjc1f/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__o5Cvz)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__xiHhD)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.freeBox__j9Nef)}>
          <SphereIcon

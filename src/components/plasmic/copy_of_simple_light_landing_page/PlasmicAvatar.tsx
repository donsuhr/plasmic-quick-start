...
import * as sty from "./PlasmicAvatar.module.css"; // plasmic-import: eVfShQMK7p7073/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <img
            alt={""}
            className={classNames(defaultcss.img, sty.img__binV)}
            role={"img"}

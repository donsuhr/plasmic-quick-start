...
import Avatar from "../../Avatar"; // plasmic-import: eVfShQMK7p7073/component
...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: FCcmf-XFuXcL-9/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: lof0VCzCP-nhzg/icon
import profilepicPTMmQiuvYhBFga from "./images/profilepic.png"; // plasmic-import: pTMmQIUVYhBFga/picture
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__dc8K)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox___4HvJt)}
        >
          <div
            className={classNames(
              defaultcss.all,

...
import Plan from "../../Plan"; // plasmic-import: vjPgiSR_DZI2Fv/component
...
import Faq from "../../Faq"; // plasmic-import: uwA43Van7poyy4/component
...
import * as sty from "./PlasmicPricing.module.css"; // plasmic-import: _FKb9IlqtNFHx5/css
      ...
      <div className={defaultcss.plasmic_page_wrapper}>
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox___0Wctt)}
          >
            <Header
            ...
            <Section
              className={classNames("__wab_instance", sty.section__bZk2W)}
              subtitle={
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox__zv6Wj)}
            >
              <Plan
                className={classNames("__wab_instance", sty.plan__a3X9J)}
                price={
                  <div
                    className={classNames(
                      defaultcss.all,
              ...
              <Plan
                className={classNames("__wab_instance", sty.plan__axkrd)}
                description={
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.freeBox___9LBq)}
                  >
                    <Bullet
                      className={classNames(
                        "__wab_instance",
              ...
              <Plan
                className={classNames("__wab_instance", sty.plan__aDjQe)}
                name={"Enterprise"}
                price={
                  <div
                    className={classNames(
            ...
            <Section
              className={classNames("__wab_instance", sty.section___2HhCr)}
              subtitle={
                <React.Fragment>
                  <div
                    className={classNames(
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__oty2M)}
                    slot={
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__zX939)}
                    slot={
                      "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                    }
                  >
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__ynX)}
                    slot={
                      "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                    }
                  >

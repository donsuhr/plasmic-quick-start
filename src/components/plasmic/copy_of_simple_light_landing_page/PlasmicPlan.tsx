...
import BaseCard from "../../BaseCard"; // plasmic-import: jLIF0zlc0iOdV2/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: vjPgiSR_DZI2Fv/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.freeBox__lZaQq)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__fvNdm)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.freeBox__vRcW)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__c8Ht)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__vapCb)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__b6Lsg)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(defaultcss.all, sty.freeBox__iL1K5)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <LinkButton
                  text={"Get started"}

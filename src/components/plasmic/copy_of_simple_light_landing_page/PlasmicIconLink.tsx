...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: BZWznY1FhGhJT/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__kLqzK)}
              role={"img"}
            />
          ),

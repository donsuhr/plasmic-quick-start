...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: uwA43Van7poyy4/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__dqMnt)}
      >
        <div className={classNames(defaultcss.all, sty.freeBox__mwMio)}>
          <div className={classNames(defaultcss.all, sty.freeBox__qj4E)}>
            {p.renderPlasmicSlot({

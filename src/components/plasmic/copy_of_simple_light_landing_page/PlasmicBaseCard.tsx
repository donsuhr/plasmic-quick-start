...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: jLIF0zlc0iOdV2/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.freeBox__kJ5Ee, {
          [sty.freeBox__long__kJ5EeE0RWp]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__mRRgy, {
            [sty.freeBox__long__mRRgyE0RWp]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__wugva)}
                role={"img"}
              />
            ),
